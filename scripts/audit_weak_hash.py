"""Detect hashlib MD5/SHA-1 use in tracked Python source."""
...
def audit_source(s:str)->list[str]:
    ...
    return [f"weak hash hashlib.{n.func.attr}() on line {n.lineno}" for n in ast.walk(t) if isinstance(n,ast.Call) and isinstance(n.func,ast.Attribute) and isinstance(n.func.value,ast.Name) and n.func.value.id=='hashlib' and n.func.attr in {'md5','sha1'}]
