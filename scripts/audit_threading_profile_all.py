...
def audit_source(source: str) -> list[str]:
    return [f"threading.setprofile_all_threads() mutates global profiling behavior on line {c.lineno}" for c in iter_calls(source) if call_name(c) == "threading.setprofile_all_threads"]
