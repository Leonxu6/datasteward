...
_ADVISORY_AUDITS = (
    ...
    "audit_atexit_register.py",
    "audit_multiprocessing_start_method.py",
    "audit_multiprocessing_executable.py",
    "audit_multiprocessing_forkserver_preload.py",
    "audit_asyncio_event_loop_policy.py",
    "audit_asyncio_set_event_loop.py",
    "audit_sys_excepthook.py",
    "audit_sys_trace.py",
    "audit_sys_profile.py",
    "audit_sys_int_max_str_digits.py",
    "audit_sys_coroutine_origin_tracking.py",
    "audit_sys_asyncgen_hooks.py",
    "audit_threading_excepthook.py",
    "audit_threading_stack_size.py",
    "audit_threading_trace_all.py",
    "audit_threading_profile_all.py",
    "audit_gc_debug.py",
    "audit_gc_threshold.py",
    "audit_random_setstate.py",
    "audit_tempfile_tempdir.py",
    "audit_urllib_install_opener.py",
    "audit_sqlite_callback_tracebacks.py",
    "audit_sqlite_shared_cache.py",
