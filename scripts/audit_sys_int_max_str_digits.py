...
def audit_source(source: str) -> list[str]:
    return [f"sys.set_int_max_str_digits() mutates a process-wide conversion limit on line {c.lineno}" for c in iter_calls(source) if call_name(c) == "sys.set_int_max_str_digits"]
